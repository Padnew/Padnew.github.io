  ...
  return (
    <>
      <div className="block bg-black text-green-500 p-4 m-6 rounded content-center w-3/5">
        ...
        <div className="bg-black text-green-500 rounded text-center overflow-hidden">
          ...
          <div className="bg-gray-900 text-green-500 p-4 my-2 rounded h-fit-contentoverflow-hidden">
